...
var gDocTable = new Array(
   new hrefList("slide0063.htm", 1, 1),
   new hrefList("slide0064.htm", 1, 2),
   new hrefList("slide0065.htm", 1, 3),
   new hrefList("slide0066.htm", 1, 4),
   new hrefList("slide0067.htm", 1, 5),
   new hrefList("slide0068.htm", 1, 6),
   new hrefList("slide0069.htm", 1, 7),
   new hrefList("slide0070.htm", 1, 8),
   new hrefList("slide0071.htm", 1, 9),
   new hrefList("slide0072.htm", 1, 10),
   new hrefList("slide0073.htm", 1, 11),
   new hrefList("slide0074.htm", 1, 12),
   new hrefList("slide0075.htm", 1, 13),
   new hrefList("slide0076.htm", 1, 14),
   new hrefList("slide0077.htm", 1, 15),
   new hrefList("slide0078.htm", 1, 16),
   new hrefList("slide0079.htm", 1, 17),
   new hrefList("slide0080.htm", 1, 18),
   new hrefList("slide0081.htm", 1, 19),
   new hrefList("slide0082.htm", 1, 20),
   new hrefList("slide0083.htm", 1, 21),
   new hrefList("slide0084.htm", 1, 22),
   new hrefList("slide0085.htm", 1, 23),
   new hrefList("slide0086.htm", 1, 24),
   new hrefList("slide0087.htm", 1, 25),
   new hrefList("slide0088.htm", 1, 26),
   new hrefList("slide0089.htm", 1, 27),
   new hrefList("slide0090.htm", 1, 28),
   new hrefList("slide0091.htm", 1, 29),
   new hrefList("slide0092.htm", 1, 30),
   new hrefList("slide0093.htm", 1, 31)
);
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "Java_Primer_for_Help_Authors_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "Java_Primer_for_Help_Authors_files/error.htm" );
	}
	else {
